...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@potonow.vn")
EMAIL_BACKEND = os.getenv(
    "EMAIL_BACKEND",
    "django.core.mail.backends.smtp.EmailBackend",
)
EMAIL_HOST = os.getenv("EMAIL_HOST", "smtp.example.com" if DEBUG else "")
EMAIL_PORT = int(os.getenv("EMAIL_PORT", "587"))
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "dev@example.com" if DEBUG else "")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD", "dev-password" if DEBUG else "")
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": str(LOGS_DIR / "fotonow.log"),
